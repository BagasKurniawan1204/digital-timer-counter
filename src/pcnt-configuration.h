...
#define CHANNEL1_PULSE            34
#define CHANNEL1_CTRL             35
...
static volatile int32_t s_ch1_last_pcnt_count = 0;


// Channel 2 variables
// static volatile int32_t s_ch2_total_count = 0;
// static volatile uint32_t s_ch2_error_count = 0;
// static volatile int32_t s_ch2_last_pcnt_count = 0;
...
esp_err_t pcnt_init() {
    ...
    pcnt_config_t pcnt_config_ch1 = {
        .pulse_gpio_num = CHANNEL1_PULSE,   
        .ctrl_gpio_num  = CHANNEL1_CTRL,     
